package com.anton.codesampler.javaIO.ConsoleIO;
 ...
 */
public class ConsoleIO extends ListActivity {
    /***
     * создаем список
     * <p>
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (position) {
            case 0:
                Intent intent = new Intent(this, GetTheStandartInput.class);
