package com.anton.codesampler.json.jsonsimple;
...
import com.anton.codesampler.json.jsonsimple.JSONSimpleExample;

/**
 * Created by rem0tec0de on 03.12.16.
 */
public class JSONSimple extends ListActivity{
    /***
     * создаем список
     * <p>
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (position) {
            case 0:
                Intent intent = new Intent(this, JSONSimpleExample.class);
