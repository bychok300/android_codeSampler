package com.anton.codesampler.JDBC.JDBCStoredProcedure;
 ...
 */
public class StoredProcedure extends ListActivity{
    /***
     * создаем список
     * <p>
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (position) {
            case 0:
                Intent intent = new Intent(this, StoredProcedureIN.class);
                startActivity(intent);
                break;
            case 1:
                Intent intent1 = new Intent(this, StoredProcedureOUT.class);
                startActivity(intent1);
                break;
            case 2:
                Intent intent2 = new Intent(this, StoredProcedureCURSOR.class);
